          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-8">
              {impactLevels.map((level) => (
                ...
                >
                  <div className="text-2xl mb-1">${level.amount}</div>
                </motion.button>
              ))}
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-4 text-2xl bg-background border border-border rounded-lg focus:outline-none focus:border-primary transition-colors"
                />
              </div>
            </div>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-xl p-8 mb-8"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-lg text-foreground/90">{currentImpact.description}</div>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
