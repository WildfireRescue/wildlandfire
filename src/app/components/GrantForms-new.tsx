    ...
    <section className="py-12 bg-background">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          >
            {/* Active Badge */}
            <div className="absolute top-8 left-1/2 -translate-x-1/2 bg-blue-500 text-white px-12 py-2 text-sm font-bold shadow-lg rounded-full">
              PROACTIVE
            </div>
          ...
          >
            {/* Closed Banner */}
            <div className="absolute top-8 left-1/2 -translate-x-1/2 bg-red-500 text-white px-12 py-2 text-sm font-bold shadow-lg rounded-full">
              CLOSED
            </div>
          ...
          >
            {/* Active Badge */}
            <div className="absolute top-8 left-1/2 -translate-x-1/2 bg-green-500 text-white px-12 py-2 text-sm font-bold shadow-lg rounded-full">
              ACTIVE
            </div>
